<?php
  include("connection.php");
    ...
    $tm=md5(time());
      ...
      $dst="students_image/".$tm.$fnm;
      $dst1=$tm.$fnm;
      move_uploaded_file($_FILES['photo']['tmp_name'],$dst);
		mysqli_query($link,"insert into student_registration values ('','$_POST[firstname]','$_POST[lastname]','$_POST[username]','$_POST[password]','$_POST[email]','$_POST[contact]','$_POST[sem]','$_POST[enrollment]','no','$dst1')");
